...
export const TOOL_REGISTRY: Tool[] = [
  ...
  },
  {
    ...
    relatedTools: ["url-encoder", "json-formatter", "html-encoder"],
  },
  {
    id: "url-encoder",
    ...
    relatedTools: ["base64", "json-formatter", "html-encoder"],
  },
  {
    id: "html-encoder",
    name: "HTML Encoder/Decoder",
    description:
      "Convert special characters to HTML entities and decode them back to plain text for XSS prevention, displaying code snippets, and safe character rendering",
    ...
    relatedTools: ["url-encoder", "base64", "markdown-previewer"],
  },
  {
    id: "regex-tester",
    name: "Regex Tester",
  ...
  },
  {
    ...
    description:
      "Generate customizable QR codes for URLs, text, vCards, WiFi, email, and SMS with color options, logo support, error correction levels, and instant download in PNG or SVG",
    ...
    relatedTools: ["url-encoder", "base64"],
  },
];
