          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                characters. The name "Base64" comes from the fact that it uses
                64 different characters to represent data: uppercase letters
                (A-Z), lowercase letters (a-z), digits (0-9), plus (+), and
                forward slash (/).
              </p>
              <p>
                ...
                handle only text data. This is particularly important for email
                systems, URLs, and data storage in text formats like JSON or
                XML.
              </p>
              <p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  commonly used over HTTPS connections for simple authentication
                  schemes.
                </p>
              </div>
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
              ...
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  JSON, or configuration files using Base64 encoding, making it
                  easier to manage and transfer without worrying about binary
                  data corruption.
                </p>
              </div>
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  JWTs, URLs, filenames, and anywhere the encoded data needs to
                  be transmitted without additional encoding.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  processed separately. This is particularly useful when working
                  with:
                </p>
            ...
            <div className="space-y-6">
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  length is always a multiple of 4. One or two equals signs may
                  appear at the end: one = means the last group had 2 bytes, and
                  two == means it had 1 byte. In URL-safe Base64, padding is
                  often omitted as it can be inferred from the data length.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  encoding process may take time and the resulting text will be
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  security are completely protected. However, remember that
                  Base64 is not encryption—anyone with access to the encoded
                  data can easily decode it.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  characters are problematic. The differences are: standard
                  Base64 uses + and / which have special meaning in URLs, while
                  Base64URL replaces them with - and _ respectively.
                  Additionally, Base64URL typically omits the padding =
                  characters. Both can be decoded to the same original
                  data—they're just different representations optimized for
                  different use cases.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  decoding actual Base64 data. If you encoded data with URL-safe
                  mode, decode it with URL-safe mode enabled as well.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  encode text in any language (Chinese, Arabic, emoji, etc.) and
                  it will work correctly. When decoding, the tool expects UTF-8
                  encoded text. If you're working with other character
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  use for any purpose, including commercial projects. There are
                  no usage limits, registration requirements, or fees. Since all
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  browsers for many years. The tool is also fully responsive and
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <ul className="mt-2 ml-6 list-disc space-y-2">
                  ...
                  <li>
                    Padding character: = (used to make output length a multiple
                    of 4)
                  </li>
                </ul>
                <p className="mt-4">
                  Each Base64 character represents exactly 6 bits of data. When
                  encoding, the input is divided into 6-bit groups, and each
                  group is mapped to its corresponding Base64 character. This is
                  why 3 bytes (24 bits) of input become 4 Base64 characters (4 ×
                  6 bits = 24 bits).
                </p>
              </div>
            </div>
