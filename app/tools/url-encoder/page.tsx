      ...
      <div className="container mx-auto px-4 py-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            ...
            form data encoding, and RFC3986 compliance. All processing happens
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                hexadecimal digits. This encoding method ensures that URLs can
                be safely transmitted over the Internet, as many protocols only
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  and pagination. Properly encoding these parameters ensures
                  that special characters in filter values, search terms, or
              ...
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  authentication failures, security issues, or redirect
                  mismatches in OAuth implementations.
                </p>
              </div>
              <div className="rounded-xl border border-green-200 bg-green-50/50 p-6 dark:border-green-800 dark:bg-green-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mb-3 text-gray-700 dark:text-gray-300">
                  ...
                  URL components like query parameters, path segments, or
                  fragment identifiers. It encodes all characters except:
                </p>
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  values, path segments, or any data that will be inserted into
                  a URL. This ensures that characters like &, =, ?, and / are
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  most characters but preserves those that have special meaning
                  in URIs, including: : / ? # [ ] @ ! $ & ' ( ) * + , ; =
                </p>
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  <strong>Use this when:</strong> Encoding an entire URL string
                  while preserving its structure. This is useful when you need
                  to encode spaces or non-ASCII characters in a URL without
                  breaking its syntax.
                </p>
                <div className="mt-4 rounded-lg bg-gray-100 p-4 font-mono text-sm dark:bg-gray-950">
                  <div className="text-gray-600 dark:text-gray-400">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  characters to be encoded, or when maximum compatibility across
                  different URL parsers is required.
                </p>
                <div className="mt-4 rounded-lg bg-gray-100 p-4 font-mono text-sm dark:bg-gray-950">
                  <div className="text-gray-600 dark:text-gray-400">
                    Example:
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  preserving characters that have special meaning in URIs (like
                  :, /, ?, #). encodeURIComponent encodes everything except
                  unreserved characters, making it suitable for encoding
                  individual components like query parameter values. Use
                  encodeURIComponent for parameter values and encodeURI only
                  when encoding an entire URL.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  encoding for space, + is specifically used in query strings
                  and form data for historical reasons. When decoding, both
                  should be treated as spaces. Our tool supports both formats.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  tool offline once the page is loaded. Your privacy and data
                  security are completely protected.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  including spaces, special characters, and non-ASCII
                  characters, should be percent-encoded. Reserved characters
                  like ?, &, =, #, / should always be encoded when they're part
                  of data, not URL structure.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  %2G where G isn't a hex digit) or incomplete encoding. Our
                  tool will display an error message if the URL can't be
                  decoded. Common issues include: missing the second hex digit
                  after %, using lowercase hex digits inconsistently, or having
                  actual % characters that should be encoded as %25. Try fixing
                  these issues manually or re-encoding the original data.
                </p>
              </details>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-blue-200 bg-blue-50/50 p-6 dark:border-blue-800 dark:bg-blue-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  forms, search queries, or any user-provided values before
                  adding them to URLs. This prevents both functionality issues
                  and security vulnerabilities like URL injection attacks.
                </p>
              </div>
              <div className="rounded-xl border border-blue-200 bg-blue-50/50 p-6 dark:border-blue-800 dark:bg-blue-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
