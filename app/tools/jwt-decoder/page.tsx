        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              ...
              be verified and trusted because it is digitally signed using a
              secret (with HMAC algorithm) or a public/private key pair (using
              RSA or ECDSA).
            </p>
            <p>
              JWTs are commonly used for authentication and information exchange
              in modern web applications. When you log into a website, the
              server creates a JWT with your user information and sends it back
              to your browser. Your browser then includes this token in
              subsequent requests to prove your identity without requiring the
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                ...
                (JWT) and the signing algorithm being used (e.g., HMAC SHA256 or
                RSA).
              </p>
  ...
  "typ": "JWT"
            ...
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                ...
                entity (typically, the user) and additional data. There are
  ...
  secret
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                The most common scenario for using JWT is authentication. Once a
                user successfully logs in, the server generates a JWT containing
                the user's identity and permissions. Each subsequent request
                includes the JWT, allowing the user to access routes, services,
                and resources that are permitted with that token. This
            ...
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                can be sure the senders are who they claim to be. Additionally,
                since the signature is calculated using the header and payload,
                you can verify that the content hasn't been tampered with during
                transmission.
              </p>
            </div>
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
            ...
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                token can include claims specifying user roles, permissions, and
                scopes, allowing fine-grained access control. Mobile apps and
                single-page applications (SPAs) commonly use JWTs to securely
                communicate with backend APIs without maintaining server-side
                sessions.
              </p>
            </div>
          </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-red-100 bg-red-50/30 p-4 dark:border-red-900 dark:bg-red-950/10">
                  ...
                  <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                    Identifies who issued the JWT. Typically a URL or identifier
                ...
                <div className="rounded-lg border border-red-100 bg-red-50/30 p-4 dark:border-red-900 dark:bg-red-950/10">
                  ...
                  <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                    Identifies the recipients that the JWT is intended for. Can
                ...
                <div className="rounded-lg border border-red-100 bg-red-50/30 p-4 dark:border-red-900 dark:bg-red-950/10">
                  ...
                  <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                    Unique identifier for the JWT. Used to prevent token replay
                    attacks in single-use scenarios.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  <strong>HS256:</strong> HMAC with SHA-256 hash function (most
                  common)
                </li>
                <li>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                RSA algorithms use asymmetric cryptography with a private/public
                key pair. The private key signs the token, and anyone with the
                public key can verify it. These algorithms include:
              </p>
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
              ...
              <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                verification where the signing service can keep the private key
                secure while distributing the public key.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                ...
                asymmetric cryptography but with elliptic curve keys, providing
          ...
          <div className="space-y-6">
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                authorization protocols that often use JWTs as the token format.
                JWT simply provides a standardized way to represent claims in a
                compact, URL-safe format. You can use JWTs with various
                authentication mechanisms including session-based auth, bearer
                tokens, or OAuth flows.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                The "none" algorithm means the JWT has no signature and provides
                no cryptographic protection. While technically valid per the JWT
                spec, it's extremely dangerous in production because anyone can
                create or modify these tokens. Attackers can change user IDs,
                permissions, or expiration dates without detection. Some
                libraries have been vulnerable to accepting "none" algorithm
                tokens even when expecting signed tokens. Always use proper
                signing algorithms in production.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                JWT lifetime depends on your security requirements and use case.
                Access tokens should be short-lived (5-15 minutes) to limit the
                window of opportunity if compromised. Refresh tokens can last
                longer (days to weeks) but should be securely stored and
                rotated. For highly sensitive operations, use even shorter
                expiration times. Always implement the "exp" (expiration) claim
                and validate it on the server side. Consider implementing token
                refresh mechanisms to maintain user sessions without requiring
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Generally, no. JWTs are Base64URL-encoded, not encrypted—anyone
                who obtains the token can decode and read its contents. Only
                include information necessary for authorization decisions (user
                ID, roles, permissions) and avoid sensitive data like passwords,
                social security numbers, or credit card details. If you must
                include sensitive data, use JWE (JSON Web Encryption) to encrypt
                the entire token, or encrypt specific claims before including
                them in the JWT.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                JWT (JSON Web Token) is signed but not encrypted—the header and
                payload are readable by anyone. JWE (JSON Web Encryption)
                encrypts the entire content, making it unreadable without the
                decryption key. JWTs are sufficient when you only need to verify
                authenticity and integrity. Use JWE when the claims themselves
                are sensitive and must be kept confidential. JWE tokens are
                typically longer and require more computational resources to
                process than JWTs.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                expiration times with refresh tokens, include a unique token ID
                (jti) and check it against a database on each request, or
                implement token versioning where changing a user's token version
                invalidates all previous tokens. Each approach has trade-offs
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                secret. Asymmetric algorithms (RS256, ES256, etc.) use a private
                key for signing and a public key for verification. The private
                key remains secret with the token issuer, while the public key
                can be freely distributed to anyone who needs to verify tokens.
                Use symmetric for single-application scenarios and asymmetric
                for distributed systems or third-party verification.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                localStorage/sessionStorage —vulnerable to XSS but not CSRF, or
                (3) memory (JavaScript variables)—most secure but lost on page
                refresh. For SPAs, many developers use HttpOnly cookies with
                SameSite=Strict or Lax and CSRF tokens. For mobile apps, use
                secure platform-specific storage. Never store tokens in regular
                cookies accessible to JavaScript, and always use HTTPS to
        ...
        <section>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                While JWTs provide a convenient way to handle authentication and
                authorization, following security best practices is crucial to
                prevent vulnerabilities:
              </p>
              <ul className="ml-6 list-disc space-y-3">
                <li>
                  <strong>Always validate signatures:</strong> Never accept JWTs
                  without verifying their signature. Implement proper signature
                  verification on the server side using trusted libraries.
                </li>
                <li>
                  <strong>Set short expiration times:</strong> Use the "exp"
                  claim and set reasonable expiration times. Access tokens
                  should expire quickly (minutes to hours), while refresh tokens
                  can last longer.
                </li>
                <li>
                  <strong>Validate all claims:</strong> Check not just the
                  signature, but also iss (issuer), aud (audience), exp
                  (expiration), and nbf (not before) claims to ensure the token
                  is intended for your application.
                </li>
                <li>
                  <strong>Use HTTPS only:</strong> Always transmit JWTs over
                  HTTPS to prevent token interception. Never send tokens in URL
                  parameters where they might be logged.
                </li>
                <li>
                  <strong>Keep secrets secure:</strong> Store signing keys
                  securely using environment variables, key management services,
                  or hardware security modules. Never commit keys to version
                  control.
                </li>
                <li>
                ...
                <li>
                  <strong>Use strong algorithms:</strong> Prefer RS256 or ES256
                  over HS256 for better security in distributed systems. Never
                  use the "none" algorithm in production.
                </li>
                <li>
                  <strong>Implement token refresh:</strong> Use short-lived
                  access tokens with separate refresh tokens to balance security
                  and user experience.
                </li>
                <li>
                  <strong>Consider token size:</strong> JWTs can grow large with
                  many claims. Monitor token size as it affects bandwidth and
                  can hit header size limits in some servers.
                </li>
              </ul>
            </div>
          </div>
