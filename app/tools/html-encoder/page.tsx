      ...
      <div className="container mx-auto px-4 py-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Convert special characters to HTML entities and decode them back to
            plain text. Essential for preventing XSS attacks, displaying code
            snippets, and ensuring proper character rendering in HTML. All
        ...
        <div className="mt-16 space-y-12">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <p>
                ...
                to prevent browsers from treating it as the beginning of an HTML
                tag. Similarly, the ampersand{" "}
                <code className="rounded bg-gray-100 px-2 py-1 dark:bg-gray-800">
                  &amp;
                </code>{" "}
                becomes{" "}
              ...
              <p>
                HTML entities come in two forms: <strong>named entities</strong>{" "}
                (like{" "}
                <code className="rounded bg-gray-100 px-2 py-1 dark:bg-gray-800">
                  &amp;copy;
                </code>{" "}
                ...
                for ©). Named entities are more readable, while numeric entities
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  from being executed. When users input text containing HTML or
                  JavaScript, encoding ensures it displays as plain text rather
                  than executable code, protecting your website and users from
                  XSS vulnerabilities.
                </p>
              </div>
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  When showing HTML, XML, or other markup code examples on your
                  website, encoding prevents the browser from interpreting tags.
                  This allows you to display code exactly as written, making it
                  perfect for tutorials, documentation, and code-sharing
                  platforms.
                </p>
              </div>
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  browsers or encodings. HTML entities ensure consistent display
                  across platforms.
                </p>
              </div>
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  When processing form submissions, encoding special characters
                  prevents issues with database storage, ensures data integrity,
                  and protects against SQL injection when combined with proper
                  parameterized queries. It's essential for safely handling user
                  input.
                </p>
              </div>
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
              ...
              <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  XML documents and RSS feeds have strict syntax rules. Encoding
                  special characters like &lt;, &gt;, and &amp; is mandatory to
                  create valid XML. This ensures your feeds parse correctly in
                  RSS readers and XML processors without syntax errors.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              These are the most commonly used HTML entities. Our tool supports
              hundreds more including Greek letters, mathematical symbols,
              arrows, and special punctuation marks.
            </p>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  regular letters and numbers, into numeric HTML entities. This
                  creates heavily obfuscated text useful for:
                </p>
                <ul className="mt-3 ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                  <li>Email address protection from spam bots</li>
                  <li>
                    Hiding text from simple scrapers while keeping it visible to
                    users
                  </li>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Process multiple independent text entries simultaneously, with
                  each line encoded or decoded separately. Perfect for:
                </p>
                <ul className="mt-3 ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  ) for transmitting data in URLs. HTML encoding is for content
                  display and XSS prevention, while URL encoding is for safe
                  transmission of data in web addresses and query parameters.
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  sufficient on its own. It prevents attacks when user input is
                  displayed in HTML content, but additional measures are needed
                  for data in JavaScript contexts, CSS, or HTML attributes. Use
                  context-aware encoding, Content Security Policy (CSP), input
                  validation, and frameworks with built-in XSS protection for
                  comprehensive security. Always follow OWASP guidelines for web
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  pages, you don't need to encode international characters (like
                  accented letters or Chinese characters), but you may choose to
                  for compatibility with older systems or email clients.
                  Encoding non-breaking spaces and special symbols depends on
                  your specific use case and target audience.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  Yes, but you'll need to decode multiple times. Sometimes data
                  gets encoded twice (like{" "}
                  <code className="rounded bg-gray-100 px-1 dark:bg-gray-800">
                    &amp;amp;lt;
                  </code>{" "}
                  instead of{" "}
                  ...
                  ). Our decoder handles one level of encoding per operation, so
                  run the decoder twice to fully decode double-encoded text. You
                  can use the swap button to quickly move output to input for
                  sequential decoding operations.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  source code, and prevention of issues with systems that don't
                  properly handle Unicode. For critical symbols (©, ®, ™) and
                  HTML-significant characters (&lt;, &gt;, &amp;), entities are
                  the safer choice.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  sent to our servers or any third party. You can verify this by
                  disconnecting from the internet after loading the page—the
                  tool will continue to work perfectly. Your privacy and data
                  security are completely protected. You can even use this tool
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  is the named entity but isn't defined in HTML4, only in XHTML
                  and HTML5. For maximum compatibility, use{" "}
                  <code className="rounded bg-gray-100 px-1 dark:bg-gray-800">
                    &amp;#39;
                  </code>{" "}
                  or simply encode as needed. Modern browsers support both, but{" "}
                  <code className="rounded bg-gray-100 px-1 dark:bg-gray-800">
                    &amp;#39;
                  </code>{" "}
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  Yes, using the "Encode All" option converts every character to
                  numeric entities, which can help hide email addresses from
                  simple spam bots. However, sophisticated scrapers can decode
                  HTML entities, so this provides only basic protection. For
                  better protection, combine entity encoding with
                  JavaScript-based rendering, contact forms instead of direct
                  mailto: links, or CAPTCHA verification. Entity encoding adds a
                  layer of obfuscation but shouldn't be your only anti-spam
                  measure.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  enabled and uses standard DOM APIs for text manipulation. The
                  tool is fully responsive and works on desktop computers,
                  tablets, and mobile devices. For best experience, use the
                  latest version of your preferred browser. Internet Explorer is
                  not supported due to missing modern JavaScript features.
                </p>
              </details>
            </div>
          </section>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <div>
                  ...
                  <p>
                    Different contexts require different encoding: HTML content
                    needs HTML entity encoding, JavaScript strings need
                    JavaScript escaping, CSS values need CSS escaping, and URLs
                    need percent-encoding. Use the right encoding method for
                    each context.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p>
                    Modern frameworks like React, Vue, and Angular automatically
                    encode output by default. Leverage these built-in
                    protections rather than manually encoding everywhere. Only
                    use manual encoding when necessary (like generating HTML
                    strings or working with legacy code).
                  </p>
                </div>
              </div>
            </div>
