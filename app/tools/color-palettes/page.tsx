    ...
    <div className="container mx-auto px-4 py-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          ...
          color schemes. Lock colors, export to CSS/SCSS/Tailwind/JSON/SVG, and
          create stunning designs. All processing happens in your browser for
          complete privacy.
        </p>
      </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              ...
              generator uses mathematical relationships between hues to produce
              aesthetically pleasing color combinations that are proven to work
              well in design.
            </p>
            <p>
              Color theory, developed over centuries by artists and scientists,
              provides rules for combining colors in ways that are visually
              appealing to the human eye. These rules are based on the color
              wheel—a circular diagram that organizes colors by their chromatic
              relationships. Our color palette generator implements these
              time-tested principles to help you create professional-looking
              color schemes in seconds.
            </p>
            <p>
              Whether you're designing a website, creating a brand identity,
              building a mobile app, or working on any visual project, choosing
              the right colors is crucial. Colors evoke emotions, communicate
              messages, establish hierarchy, and create the overall mood of your
              design. A well-chosen palette can make the difference between a
              design that feels amateur and one that looks polished and
              professional.
            </p>
            <p>
              ...
              CSS, SCSS, Tailwind CSS, JSON, SVG, and JavaScript. All processing
              happens entirely in your browser, ensuring your creative work
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                for backgrounds, UI elements, and establishing visual hierarchy
                through tints and shades.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                other on the color wheel (typically within 30-60 degrees). These
                palettes create serene, comfortable designs often found in
                nature—like the blues and greens of the ocean, or the reds,
                oranges, and yellows of a sunset. Ideal for creating harmonious
                designs without stark contrasts, perfect for backgrounds and
                ambient interfaces.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                (180 degrees apart), creating maximum contrast and visual
                impact. Examples include red and cyan, blue and orange, or
                yellow and purple. These palettes are bold, vibrant, and
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Triadic color schemes use three colors evenly spaced around the
                color wheel (120 degrees apart). The primary colors (red,
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                distributed around the color wheel (90 degrees apart), forming a
                square. These palettes offer the richest color variety but can
                be challenging to balance. They work best when one color is
                dominant and the others are used as accents. Ideal for complex
                designs, infographics, and projects requiring diverse color
                options while maintaining harmony.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Split-complementary schemes use a base color plus the two colors
                adjacent to its complement. This creates strong visual contrast
                like complementary colors but with more nuance and less tension.
                For example, if your base is blue, instead of using orange
                (complement), you'd use yellow-orange and red-orange. This
                harmony is versatile, sophisticated, and easier to balance than
                pure complementary schemes.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                and accent colors. Use triadic or tetradic palettes for diverse
                brand applications across print, digital, and merchandise.
                Export to design tools like Figma, Sketch, or Adobe Creative
                Suite. Lock your primary brand color and generate complementary
                colors that enhance your brand identity.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Build comprehensive design systems with consistent color scales.
                Generate monochromatic palettes for state variations (hover,
                active, disabled) or create accent color palettes for buttons,
                links, and interactive elements. Export to JSON for integration
                with design tokens and style guides. Perfect for maintaining
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                thumbnails, Facebook covers, and Pinterest graphics. Use vibrant
                palettes for maximum engagement or pastel palettes for a softer,
                more approachable aesthetic. Lock your brand colors and generate
                complementary palettes that maintain brand consistency while
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                palettes for natural scenes, complementary for dramatic impact,
                or triadic for balanced, colorful compositions. Export palettes
                to use in Procreate, Adobe Photoshop, Illustrator, or other
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                The color lock feature is perfect for iterative design. When you
                find a color you love, click the lock icon to preserve it while
                regenerating the rest of the palette. This is invaluable when
                working with brand colors—lock your primary brand color and
                experiment with different harmonies to find the perfect
                complementary palette. You can lock multiple colors to gradually
                build your ideal scheme.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="mt-3 space-y-3 text-gray-700 dark:text-gray-300">
                ...
                <p>
                  <strong>Tailwind Config:</strong> Exports palette in Tailwind
                  CSS configuration format, ready to add to your
                  tailwind.config.js. Use the generated colors with utility
                  classes like bg-100, text-200, etc.
                </p>
                <p>
                  <strong>JSON:</strong> Outputs a simple array of hex values in
                  JSON format, perfect for importing into design tools, storing
                  in databases, or using with JavaScript applications.
                </p>
                <p>
                ...
                <p>
                  <strong>JavaScript Array:</strong> Creates a JavaScript array
                  literal with your colors, ready to use in React components,
                  Vue templates, or any JavaScript application.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  ...
                  lightness (70-90%). Perfect for gentle, approachable designs,
                  children's content, or spring/summer themes.
                </li>
                <li>
                ...
                <li>
                  <strong>Random:</strong> Harmoniously generated random colors
                  that maintain good relationships on the color wheel while
                  providing unexpected combinations for creative exploration.
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>
                  ...
                  4.5:1 for normal text). Use our Color Picker tool for contrast
                  checking.
                </li>
                <li>
                ...
                <li>
                  <strong>Test in Multiple Contexts:</strong> View your palette
                  on different devices, screens, and in both light and dark
          ...
          <div className="space-y-6">
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                designs; and tetradic when you need maximum color variety. Start
                with the harmony that matches your brand personality, then
                experiment with different variations until you find what
                resonates.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Yes! All palettes generated by this tool are completely free to
                use for any purpose, including commercial projects, client work,
                products, and services. Colors themselves cannot be copyrighted
                (though specific combinations used in logos may be trademarked
                by companies). You own the palettes you create and can use them
                without attribution or restrictions.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                output. Paste it into your CSS file inside a :root selector like
                this: :root &#123; --color-1: #123456; --color-2: #abcdef;
                &#125;. Then use these variables throughout your CSS with
                var(--color-1), var(--color-2), etc. This makes it easy to
                change your entire color scheme by updating just the root
                variables.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                When you lock a color (by clicking the lock icon), that specific
                color will be preserved when you generate a new palette. This is
                incredibly useful when you have a brand color or a color you
                love and want to build the rest of your palette around it. You
                can lock multiple colors at once, allowing you to iteratively
                refine your palette while keeping the colors you're happy with.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                type your brand color's hex code into the input field. Then lock
                that color by clicking the lock icon. Now select different
                palette types (complementary, triadic, analogous, etc.) and
                click "Generate New" to explore different harmonies built around
                your brand color. This lets you discover professional color
                combinations that work perfectly with your existing brand
                identity.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                Vibrant palettes maximize saturation for bold, energetic colors.
                Dark palettes use low lightness for deep, rich colors perfect
                for dark mode interfaces or sophisticated designs. These presets
                help you quickly achieve a specific aesthetic without manual
                adjustments.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Yes! Click on any color swatch or use the text input below each
                color to type a new hex code directly. This allows you to fine-
                tune generated palettes or create custom combinations. Any
                manually edited color can be locked to preserve it during
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                colors to the theme.extend.colors section. For example: colors:
                &#123; 'custom': &#123; 100: '#abc123', 200: '#def456', ...
                &#125; &#125;. Then use these colors in your HTML with classes
                like bg-custom-100, text-custom-200, border-custom-300, etc.
                This integrates your generated palette seamlessly into your
                Tailwind workflow.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                databases, or tracked. Your palettes exist only in your current
                browser session. If you refresh the page, your current palette
                will be lost unless you export or save it yourself. This ensures
                complete privacy for your creative work. We recommend exporting
                palettes you want to keep for future use.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                For most projects, 3-5 colors is ideal: one dominant color, one
                or two supporting colors, and one or two accent colors. This
                provides enough variety for visual interest while maintaining
                cohesion. Complex applications or design systems might use 7-10
                colors with variations. Avoid using too many colors as it can
                create visual chaos and make your design feel unfocused. Our
                slider lets you adjust from 3-10 colors to find what works best
                for your project.
              </p>
            </details>
          </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                perceptions, and behaviors. Understanding color psychology helps
                you choose palettes that align with your message and resonate
                with your audience:
              </p>
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                ...
                <div>
                  <p className="mb-2">
                    ...
                    Enthusiasm, creativity, adventure, affordability. Works well
                    for call-to-actions, sports, and youth-oriented brands.
                  </p>
                  <p className="mb-2">
                  ...
                  <p className="mb-2">
                    ...
                    Neutrality, balance, professionalism, timelessness. Perfect
                    for backgrounds and supporting elements.
                  </p>
                  <p>
              ...
              <p className="mt-4">
                ...
                consider your target audience's cultural context when selecting
                colors for global products or diverse audiences.
              </p>
            </div>
          </div>
        </section>
