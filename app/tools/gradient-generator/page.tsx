...
export default function GradientGeneratorPage() {
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            ...
            your own custom linear, radial, and conic gradients. Export to CSS,
            SCSS, Tailwind, JSON, and SVG formats. All processing happens in
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                created entirely with CSS without requiring image files.
                Gradients add depth, visual interest, and modern aesthetics to
                web designs while maintaining fast load times and crisp displays
                at any screen resolution. Unlike images, CSS gradients are
                scalable, lightweight, and can be easily modified with code.
              </p>
              <p>
                Modern web browsers support three types of gradients: linear
                (transitions along a straight line), radial (transitions
                radiating from a center point), and conic (transitions rotating
                around a center point). Each type offers unique visual effects
                perfect for different design needs—from subtle background
                textures to bold, eye-catching hero sections.
              </p>
              <p>
                ...
                design, and establish memorable brand identities. Our generator
                provides 45+ professionally designed preset gradients plus a
                custom editor to create exactly what you envision.
              </p>
              <p>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  straight line. You control the direction using angles (0-360°)
                  or directional keywords (to top, to right, etc.). Perfect for
                  backgrounds, headers, buttons, and creating depth. Most
                  versatile and commonly used gradient type in web design. Works
                  beautifully for hero sections and card backgrounds.
                </p>
              </div>
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  points. Great for call-to-action buttons, badges, and drawing
                  attention to specific elements. Can simulate lighting effects
                  and add dimension to flat designs.
                </p>
              </div>
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Conic gradients rotate colors around a center point, creating
                  a sweeping, pie-like effect. Perfect for creating progress
                  indicators, pie charts, color wheels, and unique geometric
                  patterns. Less common but incredibly effective for specific
                  use cases. Excellent for data visualization and creating
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  visitor attention. Gradients add depth and visual interest to
                  large background areas without requiring heavy image files.
                  Combine with text overlays for effective landing pages.
                  Perfect for full-width headers, section dividers, and
                  establishing visual hierarchy. Sunset and ocean gradients are
                  particularly popular for this use.
                </p>
              </div>
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Enhance cards, pricing tables, and content blocks with subtle
                  gradient backgrounds. Use soft, pastel gradients for elegant,
                  professional looks or vibrant gradients for bold, energetic
                  designs. Gradients add sophistication to product showcases,
                  testimonial cards, and feature sections. Layer
              ...
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  grabs attention. Perfect for logos, headings, and emphasizing
                  key messages. Gradient text adds a modern, premium feel to
                  typography. Works exceptionally well for brands targeting
                  creative or tech-savvy audiences.
                </p>
              </div>
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6 dark:border-rose-800 dark:bg-rose-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Create gradient borders, dividers, and decorative accents that
                  add subtle sophistication. Use as progress bars, loading
                  indicators, or separator lines between sections. Gradient
                  borders on cards and containers add premium, modern touches.
                  Particularly effective for dark mode interfaces where subtle
                  color variations create depth.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mb-3 text-gray-700 dark:text-gray-300">
                  The simplest linear gradient transitions between two colors at
                  a specified angle:
                </p>
  ...
  background: linear-gradient(90deg, #667eea 0%, #764ba2 100%);
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  points right, 180deg points down, 270deg points left. You can
                  also use keywords like "to right", "to bottom", etc.
                </p>
              </div>
  ...
  background-clip: text;
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  shape, creating the gradient text effect. Widely supported in
                  modern browsers.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  with CSS. For most web design use cases, CSS gradients are the
                  superior choice.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  Use RGBA or HSLA color values where the alpha channel controls
                  transparency. For example: linear-gradient(to bottom,
                  rgba(255, 0, 0, 1) 0%, rgba(255, 0, 0, 0) 100%) creates a red
                  gradient that fades to fully transparent. This is perfect for
                  image overlays and fade effects. You can also use the
                  "transparent" keyword, though RGBA gives you more control.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  opacity transitions between multiple gradient layers, animate
                  gradient colors using CSS custom properties, or use
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  Firefox, Safari, Edge) without prefixes. Older browsers (IE 10
                  and below) require vendor prefixes (-webkit-, -moz-, -o-) or
                  may not support gradients at all. For maximum compatibility,
                  our generator provides clean, modern CSS that works in 99%+ of
                  browsers used today. If you need to support very old browsers,
                  consider providing a solid color fallback.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  Tailwind CSS 3.0+ includes gradient utilities out of the box.
                  Use classes like bg-gradient-to-r (right), bg-gradient-to-br
                  (bottom right), from-blue-500, via-purple-500, to-pink-500 to
                  create gradients. For custom gradients, add them to your
                  tailwind.config.js theme extension. Our export feature
                  provides Tailwind-ready code you can paste directly into your
                  configuration. You can also use arbitrary values with square
                  brackets.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  "right" angle depends on your design context—experiment to see
                  what feels best. Many designers prefer 135deg as it creates
                  natural-feeling shadows and depth.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  clip. A common technique: create a container with the gradient
                  background, add padding equal to your desired border width,
                  and set the inner element's background to match your page
                  background. Gradient borders add sophisticated, modern touches
                  to cards, buttons, and containers.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  darkest/lightest parts of your gradient. Use our Color Picker
                  tool to check contrast ratios (minimum 4.5:1 for normal text).
                  Add semi-transparent dark or light overlays between the
                  gradient and text. Use text shadows for additional
                  readability. Test with real content—what looks good with short
                  headings may not work with longer paragraphs. Consider using
                  white text on dark gradients or dark text on light gradients.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  tools. You can also copy the color codes and manually recreate
                  the gradient in your design software. The JSON export provides
                  all gradient information (colors, positions, angles) in a
                  structured format that can be parsed programmatically or used
                  as a reference for manual implementation.
                </p>
              </details>
            </div>
          </section>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  high-contrast effects. Analogous colors (adjacent on the color
                  wheel) create harmonious gradients.
                </p>
                <p>
                  ...
                  Complement your brand personality and content with appropriate
                  color temperatures.
                </p>
                <p>
                ...
                <p>
                  ...
                  variations) often work better than dramatic color shifts. They
                  add depth without overwhelming content or competing with
                  foreground elements.
                </p>
                <p>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Generate harmonious color palettes for your gradient projects
                </p>
              </a>
              <a
