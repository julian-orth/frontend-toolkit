          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                While UUIDs appear as opaque 128-bit identifiers, certain
                versions encode meaningful data that can be extracted: version 1
                and version 7 UUIDs contain timestamps, version 1 UUIDs may
                include node identifiers (MAC addresses), and all UUIDs carry
                version and variant indicators in specific bit positions.
              </p>
              <p>
                ...
                producing the expected UUID versions. For example, if your API
                is supposed to generate v4 random UUIDs but you discover it's
                actually generating v1 UUIDs, this could have privacy
                implications since v1 may expose machine information.
              </p>
              <p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  events occurred in distributed systems. This helps debug race
                  conditions, verify event ordering in event sourcing systems,
                  or investigate timing issues. Timestamps provide approximate
              ...
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  UUIDs conform to RFC 4122 variant specifications, and check
                  for consistency in version usage across records. Decoding
                  helps identify malformed or non-standard UUIDs that could
                  cause issues in downstream processing.
                </p>
              </div>
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  variant in 2-3 bits (the N position). The decoder parses these
                  bits to identify the UUID type. Version indicates the
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  12 hex digits. Originally this was the IEEE 802 MAC address of
                  the generating machine's network interface. Modern
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  embedded timestamps (100-nanosecond precision since 1582) and
                  node identifiers (potentially MAC addresses). Version 7 UUIDs
                  contain Unix timestamps in milliseconds. Version 3 and 5 are
                  hashed values that cannot be reversed to extract original
                  input. Version 4 is purely random with no extractable
                  information. All versions include version and variant
                  indicators in specific bit positions.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  values for the node field with the multicast bit set to
                  indicate it's not a real MAC address. Check the decoded node
                  identifier—if the least significant bit of the first octet is
                  1, it's multicast (random). If 0, it could be a real unicast
                  MAC address. Most modern UUID libraries use random node IDs
                  for privacy.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  The UUID epoch starts at October 15, 1582 00:00:00 UTC, which
                  is the date the Gregorian calendar was first adopted. This
                  ...
                  providing extremely high precision. The decoder converts this
                  to Unix epoch (January 1, 1970) for familiar date display.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  almost all modern UUIDs use. There are historical variants
                  from older specifications (NCS, Microsoft, reserved) that used
                  different bit layouts. If a UUID doesn't have RFC 4122
                  variant, it may not decode correctly or may be from a legacy
                  system. The decoder identifies the variant to help validate
                  UUID conformance.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  identifiers with the same confidentiality as the original
                  UUIDs. Use this tool in secure environments when analyzing
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  decoding, consider using programming libraries in your
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  whenever the clock appears to have gone backward relative to
                  the last UUID generated. This ensures uniqueness even with
                  clock adjustments. The decoded clock sequence value itself
                  isn't particularly useful—it's mainly an internal mechanism
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  clock-dependent. Node IDs may be random or real MAC addresses.
                  Always use explicit fields in your data model for
                  authoritative information. Decode for troubleshooting, not as
                ...
                <p>
                  ...
                  random UUIDs but discover v1, investigate immediately—this
                  could have privacy or performance implications. Set up
                  monitoring to alert on unexpected UUID version changes.
                </p>
                <p>
                  ...
                  details. Redact or anonymize decoded data when sharing in
                  public forums, documentation, or bug reports. Treat decoded
                  information with the same confidentiality as the source UUIDs.
                </p>
                <p>
                ...
                <p>
                  ...
                  are used where and why. This helps future developers
                  understand identifier strategies and makes system integration
                  smoother. Include UUID version requirements in API
