...
export const metadata: Metadata = {
  ...
  description:
    "Decode and analyze UUIDs: extract version, variant, and timestamp (for v1).",
  keywords: [
    "uuid",
    "decode",
    "analyze",
  ...
  openGraph: {
    ...
    description:
      "Decode and analyze RFC 4122 UUIDs. Extract version, variant, and timestamp (for v1 UUIDs).",
  },
  twitter: {
    card: "summary",
    title: "UUID Decoder & Analyzer",
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Decode and analyze UUIDs: extract version, variant, and timestamp (for
          v1 UUIDs).
        </p>
      </div>
