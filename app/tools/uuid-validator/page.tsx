          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                must have the correct length (32 hexadecimal digits plus
                optional 4 hyphens), use only valid hexadecimal characters (0-9,
                a-f, A-F), follow the proper format (8-4-4-4-12 hyphen pattern),
                and have correct version and variant bits in their designated
                positions.
              </p>
              <p>
                ...
                database constraint violations, or silent data corruption.
                Proper validation at input boundaries (API endpoints, file
                imports, user forms) ensures data quality and system
                reliability. This is especially important when accepting UUIDs
                from external sources, third-party integrations, or user input.
              </p>
              <p>
                This validator checks both format (string structure) and RFC
                4122 compliance (version and variant bits). It identifies common
                problems: incorrect length, non-hexadecimal characters, wrong
                hyphen placement, invalid version numbers, and non-RFC 4122
                variants. The validator provides clear feedback about what's
                wrong with invalid UUIDs, making it easy to troubleshoot UUID
                generation or parsing issues.
              </p>
            </div>
          </section>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  processes ensures only well-formed identifiers enter your data
                  warehouse.
                </p>
              </div>
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  non-standard identifiers. Validation ensures you only process
                  compatible identifiers and reject incompatible formats early.
                </p>
              </div>
              <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  that are too short, too long, have hyphens in wrong positions,
                  or contain non-hex characters like 'g', 'z', or special
                  symbols.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  name-based), 7 (time- ordered), or 0 (NIL UUID). Rejects UUIDs
                  with version numbers 2, 6, 8-15 as these are either reserved
                  or not part of the standard specification.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  should only be used as a placeholder value, never as an actual
                  entity identifier.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  placement (should be 8-4-4-4-12), invalid version number (must
                  be 1, 3, 4, 5, 7, or 0 for NIL), or wrong variant bits (should
                  be RFC 4122 variant). Also invalid: missing hyphens when
                  expected, extra characters, leading/ trailing whitespace, or
                  completely random strings that happen to be 32 characters.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  created non-random v4 UUID with predictable values, or a v1
                  UUID with an invalid timestamp. Format validation only checks
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  points, trust internal data after validation, and use fast
                  regex or built-in validation functions rather than complex
                  parsing.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  lowercase in your storage and APIs to prevent duplicate
                  entries from case differences (e.g., treating A1B2... and
                  a1b2... as different values).
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  accepts both formats. When accepting UUID input, support both
                  formats but normalize to your preferred representation for
                  storage.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  to the specification. A UUID can have valid format but fail
                  RFC compliance if version/variant bits are wrong. Always
                  validate both for true UUID compliance—format alone isn't
                  enough.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  UUIDs with wrong format (e.g., missing hyphens), normalize
                  them. For corrupted data, check backups or source systems.
                  Prevention is key: add validation constraints, use native UUID
                  types, and validate input at application boundaries.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  detailed error messages, and integrate with your error
                  handling framework.
                </p>
              </details>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  Bad Request with descriptive error messages for invalid UUIDs.
                  Never let invalid UUIDs propagate into your business logic or
                  database layers where they can cause crashes or data
                  corruption.
                </p>
                <p>
