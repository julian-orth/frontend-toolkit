      ...
      <div className="mt-16 space-y-12">
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              ...
              removed, or modified between two texts. This makes it easy to spot
              changes at a glance without manually reading through both
              documents.
            </p>
            <p>
            ...
            <p>
              Text diff tools are ubiquitous in software development, used daily
              by millions of developers through version control systems like
              Git, code review platforms like GitHub and GitLab, and integrated
              development environments (IDEs). They're also valuable for
              writers, editors, legal professionals, and anyone who needs to
              track changes in text documents over time.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                documents. Identify what collaborators or editors have modified,
                ensure no important content was accidentally deleted, and
                maintain version control for important documents without complex
                software.
              </p>
            </div>
            <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                configs, database settings, or application configurations. Catch
                accidental changes or missing environment variables that could
            ...
            <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                help visualize conflicting changes, understand what each version
                contains, and make informed decisions about which changes to
                keep or how to combine them.
              </p>
            </div>
            <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                removed warnings, or changed patterns in log output. Useful for
                troubleshooting issues and understanding system behavior changes
                after deployments.
              </p>
            </div>
            <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                ...
                simultaneously. The original text appears on the left, modified
                text on the right:
              </p>
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  ...
                  Lines removed from the original appear only in the left column
                  with red background highlighting
                </li>
                <li>
                ...
                <li>
                  <strong>Unchanged lines:</strong> Appear in both columns with
                  normal styling, providing context around changes
                </li>
                <li>
                  <strong>Line numbers:</strong> Both columns show line numbers
                  to help navigate and reference specific changes
                </li>
              </ul>
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Split view is excellent for understanding the overall structure
                and context of changes. It's the preferred view when you need to
                see how changes affect the surrounding code or text, making it
                ideal for code reviews and detailed analysis.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mb-3 text-gray-700 dark:text-gray-300">
                Unified view displays both texts in a single column with visual
                markers indicating the type of change. This is the format used
                by Git and other version control systems:
              </p>
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  <strong className="text-red-600 dark:text-red-400">
                ...
                <li>
                  <strong>Lines with no prefix:</strong> Unchanged context lines
                  that provide surrounding context for changes
                </li>
                <li>
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                Git. Perfect for getting a quick overview of all changes or when
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Options like "ignore whitespace" and "newlines as tokens" refine
                how lines are compared, letting you focus on meaningful changes
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                punctuation marks, comparing each as a separate token. Within a
                line, specific words that changed are highlighted. Best for:
              </p>
              <ul className="mt-3 ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                ...
                <li>Maintaining readability while showing granular changes</li>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Character-by-character mode provides the finest level of detail,
                highlighting every single character that differs. This mode
                shows:
              </p>
              <ul className="mt-3 ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                ...
                <li>Whitespace changes, extra spaces, or formatting issues</li>
                <li>
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                changes. Use it when you need to see every modification or when
                comparing short texts where precision matters more than
                overview.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-6">
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                This tool uses the Myers diff algorithm (developed by Eugene W.
                Myers in 1986), which is the industry standard for computing
                differences between texts. It's the same algorithm powering Git,
                Unix diff, and most modern version control systems. The Myers
                algorithm efficiently finds the shortest edit script (smallest
                set of changes) to transform one text into another, making it
                both fast and accurate even for large files.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                apply patch.diff" for Git repositories, "patch &lt; patch.diff"
                for Unix patch command, or import it into version control
                systems. The patch includes headers showing old and new file
                names, line number ranges (@@), and all changes with +/-
                markers, making it a portable way to share or apply changes.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                affect functionality but can create hundreds of false "changes."
                This is especially important when: comparing code formatted by
                different editors or linters, reviewing changes after auto-
                formatting, working across different operating systems (Windows
                vs Unix line endings), or when team members use different
                tab/space settings. Ignoring whitespace lets you focus on actual
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                view combines both texts into a single column with +/- markers,
                which is more compact and matches Git's output format. Use split
                view for detailed review and context, unified view for quick
                scanning or when familiar with Git patch format.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                No, this tool is designed specifically for text file comparison.
                Binary files (images, executables, compressed files, PDFs)
                require specialized binary diff tools that work with bytes
                rather than text characters. For images, use visual diff tools
                that show pixel-by-pixel differences. For other binary files,
                consider tools like vbindiff or specialized diff utilities
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                comparing very large files (10MB+), consider using command-line
                tools like diff, git diff, or specialized diff utilities
                designed for large-scale comparisons that don't run in the
                browser.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Use word-by-word comparison for prose, documentation, articles,
                or any natural language text where you want to see which
                specific words changed while maintaining readability. Use
                character-by-character for precise comparison needs: finding
                typos, comparing short strings, analyzing data values, or when
                you need to see exactly where individual characters differ.
                Line-by- line is best for code or structured text where line
                boundaries matter.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                will continue to work offline. This makes it completely safe to
                compare sensitive documents, proprietary code, confidential
                contracts, or any private data.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                The "ignore case" option makes the comparison case-insensitive,
                treating uppercase and lowercase letters as equivalent. For
                example, "Hello" and "hello" would be considered identical. This
                is useful when comparing: user-generated content where
                capitalization varies, case-insensitive programming languages,
                text where capitalization doesn't affect meaning, or when you
                want to focus on content changes rather than formatting. It
                works with word and character comparison modes but not
                line-by-line.
              </p>
            </details>
          </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                line-by-line comparison in split view to get a quick overview of
                changes. This helps you understand the scope and type of
                modifications before diving into details. Once you've identified
                interesting sections, switch to word or character mode for
                detailed analysis.
              </p>
              <p>
                <strong>Use appropriate comparison modes:</strong> Match the
                comparison mode to your content type. Code and configuration
                files benefit from line-by-line with whitespace ignored. Natural
                language documents work better with word-by-word comparison.
                Precise string or data comparison needs character-by-character
                mode.
              </p>
              <p>
                <strong>Leverage view options strategically:</strong> Enable
                "ignore whitespace" when formatting changes obscure real content
                changes. Use "ignore case" for case-insensitive comparisons.
                Turn on "newlines as tokens" when paragraph structure changes
                are important. These options help you focus on the changes that
                actually matter.
              </p>
              <p>
                <strong>Save important diffs as patches:</strong> When you need
                to share changes or apply them later, export to unified diff
                patch format. This creates a portable,
              ...
              <p>
                ...
                reviewing major rewrites or large updates, break the comparison
                into smaller chunks. Compare files section by section or
                function by function to make the review process more manageable
                and reduce the chance of missing important changes.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                The Myers algorithm finds the shortest edit script (SES) between
                two sequences—the minimum set of insertions and deletions needed
                to transform one text into another. It uses a graph-based
                approach where: the x-axis represents the original text, y-axis
                represents the modified text, and the algorithm finds the
                shortest path through this edit graph. This guarantees optimal
                results: the smallest possible diff that accurately represents
                changes.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>
                  <strong>Deletions:</strong> Lines prefixed with - (minus sign)
                </li>
                <li>
                  <strong>Additions:</strong> Lines prefixed with + (plus sign)
                </li>
              </ul>
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                This format is standardized and recognized by all major version
                control systems, making patches portable and widely compatible.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="mb-6 text-gray-700 dark:text-gray-300">
            Explore other text processing and development tools to enhance your
            workflow:
          </p>
