          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <p>
                ...
                perfect for version control systems like Git, where you can see
                the actual content changes without wading through formatting
                tags.
              </p>
              <p>
                GitHub-flavored Markdown (GFM) extends the original
                specification with additional features like tables, task lists,
                strikethrough text, and automatic URL linking. These extensions
                have become so popular that they&apos;re now supported by many
                Markdown parsers and editors.
              </p>
            </div>
          </section>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  guidelines in a format that&apos;s both readable in plain text
                  and beautifully rendered on GitHub.
                </p>
              </div>
              <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
                <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <div className="rounded-xl border border-yellow-200 bg-yellow-50/50 p-6 dark:border-yellow-800 dark:bg-yellow-950/20">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  emails. This is particularly popular among developers who
                  prefer writing in plain text while still being able to format
                  their messages with headings, lists, and code blocks.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  and layout. Markdown is typically converted to HTML for
                  display on websites. Think of Markdown as a simpler, more
                  readable way to write content that will eventually become
                  HTML.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  not just on GitHub, but across many platforms and tools
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  don&apos;t have Markdown equivalents (like centered text,
                  custom colors, or complex tables). However, mixing too much
                  HTML can defeat the purpose of using Markdown in the first
                  place, which is simplicity and readability. Use HTML sparingly
                  when Markdown&apos;s syntax can&apos;t achieve what you need.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  tool offline once the page is loaded. Your content stays
                  private and secure on your device. We don&apos;t track, store,
                  or have access to anything you write in the editor.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  conversion to formats like PDF, Word, or LaTeX, you&apos;d
                  need to use additional tools like Pandoc.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  followed by a language name (e.g., ```javascript), the preview
                  will show syntax-highlighted code. This works for dozens of
                  programming languages including JavaScript, Python, Java, C++,
                  HTML, CSS, and many more. Syntax highlighting makes code
                  examples easier to read and more professional-looking in
                  documentation.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  the beginning of a line or be properly indented. Check that
                  code blocks use three backticks on their own lines. If
                  you&apos;re copying from another editor, invisible characters
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  :---: for center, and ---: for right alignment. While table
                  syntax can be a bit tedious to write by hand, many editors
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  them. This interactive editor is perfect for practice—just
                  start typing and see the results instantly. Keep a Markdown
                  cheat sheet handy for reference. Within a few hours of use,
                  you&apos;ll find the syntax becomes second nature. Most people
                  can master the commonly-used Markdown features in an
                  afternoon.
                </p>
              </details>
              ...
              <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                ...
                <p className="mt-3 text-gray-700 dark:text-gray-300">
                  ...
                  :smile:, :heart:, or :rocket: which render as emoji
                  characters. You can also paste emoji directly into your
                  Markdown text, and they&apos;ll appear in the output. This
                  tool supports both methods. Emoji are great for adding visual
                  interest to documentation, README files, and informal content.
                  A full list of GitHub emoji codes is available in the GitHub
                  emoji cheat sheet.
                </p>
              </details>
            </div>
