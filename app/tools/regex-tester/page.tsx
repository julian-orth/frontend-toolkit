    ...
    <div className="container mx-auto px-4 py-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          ...
          capture groups, and comprehensive flag support. All processing happens
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              ...
              to match, search, and manipulate text. They provide a concise and
              flexible way to identify strings of text, such as specific
              characters, words, or patterns within larger text bodies. Regular
              expressions are supported in virtually every modern programming
              language including JavaScript, Python, Java, PHP, Ruby, and many
              others.
            </p>
            <p>
              A regex pattern is composed of a sequence of characters that
              define a search pattern. These patterns can include literal
              characters (like "cat"), special characters called metacharacters
              (like . * + ? [ ] {} ( ) ^ $ | \), and character classes. The true
              power of regular expressions lies in their ability to express
              complex matching logic in a compact, declarative syntax.
            </p>
            <p>
              ...
              became widely adopted in Unix tools like grep, sed, and awk in the
              1970s. Today, they are an essential tool for developers, data
              analysts, and anyone working with text processing and validation.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                that would be impossible with simple string matching, including
                capturing and reusing matched groups.
              </p>
            </div>
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                Parse structured or semi-structured text to pull out URLs,
                dates, prices, IDs, or any identifiable pattern for further
            ...
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                parameters from URL paths. Express.js, Django, Rails, and other
                frameworks rely on regex for flexible routing and parameter
                extraction in web applications.
              </p>
            </div>
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                error messages, timestamps, IP addresses, user agents, or other
                relevant information. Regex patterns help identify patterns in
                large log files for monitoring and debugging.
              </p>
            </div>
            <div className="rounded-xl border border-red-200 bg-red-50/50 p-6 dark:border-red-800 dark:bg-red-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                comments, and other language constructs for syntax highlighting.
                This makes code more readable and helps developers quickly
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Without the global flag, regex matches only the first occurrence
                in the string. With the global flag enabled, the regex continues
                searching and returns all matches throughout the entire string.
                Essential for find-and-replace operations and comprehensive text
                analysis.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                other case variation. Particularly useful when you want to match
                text regardless of capitalization, such as user input or natural
                language text.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                only at the end. With the multiline flag, ^ matches at the start
                of each line and $ matches at the end of each line. Crucial for
                working with multi-line text or documents.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                Useful when you need to match patterns that span multiple lines.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                searches from the last match position, the sticky flag requires
                the match to occur exactly at lastIndex. Used in parsers and
                tokenizers for sequential matching.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Use curly braces with numbers to specify exact counts or ranges.
                For example: \d{`{3}`} matches exactly 3 digits, \d{`{3,5}`}{" "}
                matches 3 to 5 digits, and \d{`{3,}`} matches 3 or more digits.
                This is more precise than using + (one or more) or * (zero or
                more) quantifiers.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                groups capture the area code and number separately from a phone
                number like "555-1234". You can reference these groups in
                replacements using $1, $2, etc., or access them programmatically
                in your code.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                By default, quantifiers like *, +, and {`{n,m}`} are greedy—they
                match as much text as possible. For example, .* in the string
                "&lt;div&gt;content&lt;/div&gt;" matches the entire string.
                Adding a ? after the quantifier makes it lazy: .*? matches as
                little as possible, so it would match just "&lt;div&gt;" first.
                Use lazy matching when you want to match the shortest possible
                string.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                "category" or "scat". Word boundaries are essential for matching
                complete words without accidentally matching parts of longer
                words.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                parse nested or recursive structures like HTML, XML, or balanced
                parentheses. While you can write regex patterns to match simple,
                non-nested cases, attempting to match properly nested structures
                will fail or produce incorrect results. For parsing HTML or XML,
                use dedicated parsing libraries like DOMParser, BeautifulSoup,
                or xml2js instead.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                correctly with Unicode. For example, use /[\u0400-\u04FF]+/u to
                match Cyrillic characters, or /\p{`{Emoji}`}/u to match emoji
                when supported by your regex engine.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                ( ) | \, you need to escape them with a backslash. For example,
                to match "example.com", use example\.com. To match a backslash
                itself, use \\. If you're dynamically building regex patterns
                from user input, use a function to escape all special characters
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Lookaheads and lookbehinds are zero-width assertions that check
                for patterns without including them in the match. Positive
                lookahead (?=...) ensures a pattern follows, negative lookahead
                (?!...) ensures it doesn't. For example, \d+(?= dollars) matches
                numbers followed by " dollars" but doesn't include " dollars" in
                the match. Lookbehinds work similarly: (?&lt;=...) checks what
                comes before, (?&lt;!...) checks what doesn't come before.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Yes, absolutely. All regex testing and matching happens entirely
                in your browser using JavaScript. No patterns or test strings
                are ever sent to our servers or any third party. You can even
                use this tool offline once the page is loaded. Your privacy and
                data security are completely protected. This tool is safe to use
                with sensitive data or proprietary patterns.
              </p>
            </details>
          </div>
        </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                <div className="flex justify-between">
                  <code className="text-red-600 dark:text-red-400">[abc]</code>
                  <span className="text-gray-600 dark:text-gray-400">
                    Any of a, b, or c
                  </span>
                </div>
                <div className="flex justify-between">
                  <code className="text-red-600 dark:text-red-400">[a-z]</code>
                  <span className="text-gray-600 dark:text-gray-400">
