        ...
        <div className="mx-0 max-w-7xl">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Generate cryptographic hashes using MD5, SHA-1, SHA-256, and
              SHA-512 algorithms. Support for HMAC, multiple input formats, and
              instant browser-based processing for complete privacy.
            </p>
          </div>
          ...
          <div className="mt-16 space-y-12">
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  takes an input (or &apos;message&apos;) and returns a
                  fixed-size string of bytes called a hash value, message
                  digest, or simply hash. The output is typically a hexadecimal
                  number that uniquely represents the input data.
                </p>
                <p>
                  ...
                  value, making hash functions ideal for detecting data
                  tampering and ensuring data integrity.
                </p>
                <p>
                  Unlike encryption, which is designed to be reversible with the
                  correct key, hash functions are intentionally irreversible.
                  This makes them perfect for password storage, digital
                  signatures, and verifying data hasn&apos;t been corrupted or
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    stronger algorithms combined with salting and key
                    stretching.
                  </p>
                </div>
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Software downloads often include SHA-256 checksums that
                    allow users to verify the downloaded file hasn&apos;t been
                    corrupted or tampered with. Comparing the hash of the
                    downloaded file with the published hash confirms
                    authenticity.
                  </p>
                </div>
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Hash functions are essential in digital signature schemes.
                    The document is hashed first, then the hash is encrypted
                    with a private key. This ensures authenticity and
                    non-repudiation while keeping signature sizes manageable.
                  </p>
                </div>
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Bitcoin and other cryptocurrencies use SHA-256 extensively
                    for mining and creating secure, tamper-proof chains of
                ...
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    stored only once, saving storage space while maintaining
                ...
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    functions with a secret key to verify both data integrity
                    and authenticity in API requests, webhooks, and secure
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-6 dark:border-yellow-800/50 dark:bg-yellow-950/20">
                  ...
                  <p className="text-yellow-800 dark:text-yellow-300">
                    ...
                    SHA-256 or SHA-512 for any security-critical applications.
                    MD5 is acceptable only for non-security purposes like
            ...
            <section>
              ...
              <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                <p className="text-gray-700 dark:text-gray-300">
                  HMAC (Hash-based Message Authentication Code) is a mechanism
                  for calculating a message authentication code involving a
                ...
                <div className="space-y-3">
                  ...
                  <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      <strong>Integrity:</strong> Ensures the message
              ...
              <div className="space-y-6">
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    and irreversible. You cannot recover the original input from
                    a hash. This is a fundamental property of hash functions,
                    not a bug or limitation. However, weak hashes like MD5 can
                    be vulnerable to rainbow table attacks where pre-computed
                    hashes are used to guess common inputs.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    data. Hashing is one-way and irreversible. Encryption
                    protects confidentiality, while hashing ensures integrity
                    and is used for verification, not secrecy. Never use hash
                    functions when you need to retrieve the original data later.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    <strong>SHA-256 or SHA-512</strong>. Avoid MD5 and SHA-1 as
                    they&apos;re cryptographically broken. For general-purpose
                    checksums where security isn&apos;t a concern, MD5 is
                    acceptable. For password hashing, use specialized algorithms
                    like bcrypt, scrypt, or Argon2 instead of plain hash
                    functions. For blockchain applications, SHA-256 is the
                    industry standard.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    A hash collision occurs when two different inputs produce
                    the same hash output. While theoretically possible due to
                    the pigeonhole principle (infinite inputs, finite outputs),
                    good hash functions make collisions extremely unlikely. MD5
                    and SHA-1 are vulnerable to collision attacks, which is why
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    your browser using the Web Crypto API. No data is ever sent
                    to our servers or any third party. You can even use this
                    tool offline once the page is loaded. Your sensitive data
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    Hash functions produce fixed-size outputs regardless of
                    input size. MD5 always produces 128 bits (32 hex
                    characters), SHA-256 always produces 256 bits (64 hex
                    characters), and SHA-512 always produces 512 bits (128 hex
                    characters). This consistency makes hashes predictable and
                    suitable for storage in databases and comparison operations.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    integrity only—anyone can compute them. HMAC requires a
                    secret key, so only parties with the key can generate valid
                    signatures. This is essential for API authentication,
                    message verification, and preventing tampering in untrusted
                    environments.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    Unicode characters including emoji and international text.
                    For file hashing, you can paste the file content, though for
                    large binary files, specialized tools are more appropriate.
                    The tool automatically handles character encoding to ensure
                    consistent results.
                  </p>
                </details>
                ...
                <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mt-3 text-gray-700 dark:text-gray-300">
                    ...
                    unique salt stored alongside their hash. This means
                    attackers must compute rainbow tables for each salt, making
                    pre-computed attacks impractical. Salting is crucial for
                    password security but isn&apos;t needed for checksums or
                    file verification.
                  </p>
                </details>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <ul className="ml-6 list-disc space-y-2">
                    ...
                    <li>
                      <strong>SHA-256:</strong> Part of SHA-2 family, widely
                  ...
                  <div className="mt-6 rounded-lg bg-indigo-50 p-4 dark:bg-indigo-950/30">
                    ...
                    <p className="text-sm">
                      ...
                      computations are performed locally—no server round-trips
