          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Storing password hashes instead of plain text passwords ensures
                that even if a database is compromised, the actual passwords
                remain protected. Modern systems use SHA-256 or stronger
                algorithms combined with salting and key stretching.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                or tampered with. Comparing the hash of the downloaded file with
                the published hash confirms authenticity.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                private key. This ensures authenticity and non-repudiation while
                keeping signature sizes manageable.
              </p>
            </div>
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-gray-50">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                mining and creating secure, tamper-proof chains of transactions.
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/50 p-6 dark:border-indigo-800 dark:bg-indigo-950/20">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Cloud storage and backup systems use hash functions to identify
                duplicate files. Files with identical hashes are stored only
                once, saving storage space while maintaining data integrity
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-6 dark:border-yellow-800/50 dark:bg-yellow-950/20">
              ...
              <p className="text-yellow-800 dark:text-yellow-300">
                <strong>MD5 and SHA-1 are cryptographically broken</strong> and
                should not be used for security purposes. Collision attacks have
                been demonstrated for both algorithms. Use SHA-256 or SHA-512
                for any security-critical applications. MD5 is acceptable only
                for non-security purposes like checksums for data corruption
                detection.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            ...
            <div className="space-y-3">
              ...
              <ul className="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>
                  <strong>Secret Key:</strong> Only parties with the secret key
                  can generate valid HMACs
                </li>
                <li>
                  <strong>Algorithm Agnostic:</strong> Can be used with any hash
                  function (HMAC-MD5, HMAC-SHA256, etc.)
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                No, cryptographic hash functions are designed to be one-way and
                irreversible. You cannot recover the original input from a hash.
                This is a fundamental property of hash functions, not a bug or
                limitation. However, weak hashes like MD5 can be vulnerable to
                rainbow table attacks where pre-computed hashes are used to
                guess common inputs.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                No, they serve different purposes. Encryption is designed to be
                reversible with the correct key—you can decrypt encrypted data.
                Hashing is one-way and irreversible. Encryption protects
                confidentiality, while hashing ensures integrity and is used for
                verification, not secrecy. Never use hash functions when you
                need to retrieve the original data later.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                Avoid MD5 and SHA-1 as they&apos;re cryptographically broken.
                For general-purpose checksums where security isn&apos;t a
                concern, MD5 is acceptable. For password hashing, use
                specialized algorithms like bcrypt, scrypt, or Argon2 instead of
                plain hash functions. For blockchain applications, SHA-256 is
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                hash functions make collisions extremely unlikely. MD5 and SHA-1
                are vulnerable to collision attacks, which is why they&apos;re
                deprecated. SHA-256 and SHA-512 are currently
                collision-resistant.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                Absolutely. All hash calculations are performed entirely in your
                browser using the Web Crypto API. No data is ever sent to our
                servers or any third party. You can even use this tool offline
                once the page is loaded. Your sensitive data remains completely
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                size. MD5 always produces 128 bits (32 hex characters), SHA-256
                always produces 256 bits (64 hex characters), and SHA-512 always
                produces 512 bits (128 hex characters). This consistency makes
                hashes predictable and suitable for storage in databases and
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                ...
                key, so only parties with the key can generate valid signatures.
                This is essential for API authentication, message verification,
                and preventing tampering in untrusted environments.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                While you can technically hash passwords with SHA-256, it&apos;s
                not recommended for production systems. Password hashing
                requires specialized algorithms like bcrypt, scrypt, or Argon2
                that are designed to be slow and include automatic salting. This
                tool is best for testing, learning, or generating hashes for
                non-password data like file checksums and API signatures.
              </p>
            </details>
            ...
            <details className="group rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
              ...
              <p className="mt-3 text-gray-700 dark:text-gray-300">
                This tool supports plain text (UTF-8), hexadecimal strings, and
                Base64-encoded data as input formats. UTF-8 handles all Unicode
                characters including emoji and international text. For file
                hashing, you can paste the file content, though for large binary
                files, specialized tools are more appropriate. The tool
        ...
        <section>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                This tool uses the{" "}
                <strong>Web Crypto API (SubtleCrypto)</strong> built into modern
                browsers for native, hardware-accelerated hash computation. The
                Web Crypto API provides cryptographically secure implementations
                of:
              </p>
              <ul className="ml-6 list-disc space-y-2">
                <li>
                  <strong>SHA-1:</strong> Part of the SHA family, now deprecated
                  for security use
                </li>
                <li>
              ...
              <p className="mt-4">
                ...
                vulnerabilities), we use a JavaScript implementation. Note that
                MD5 is provided for compatibility and legacy checksums only—it
              ...
              <div className="mt-6 rounded-lg bg-indigo-50 p-4 dark:bg-indigo-950/30">
                ...
                <p className="text-sm">
                  ...
                  37+, Firefox 34+, Safari 11+, Edge 12+. All hash computations
                  are performed locally—no server round-trips or external
                  dependencies.
                </p>
              </div>
            </div>
